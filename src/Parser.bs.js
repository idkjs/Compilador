...
function parse_termino(tokenList) {
  ...
  if (tokenList$1) {
    ...
    if (!(Token.identificador(token) === "Multiplication" || Token.identificador(token) === "Division")) {
      return [
              {
                TAG: /* Ter */0,
                _0: fac1
...
function parse_exp(tokenList) {
  ...
  if (tokenList$1) {
    var token = tokenList$1.hd;
    if (!(Token.identificador(token) === "Addition" || Token.identificador(token) === "Negation")) {
      return [
              {
                TAG: /* Expr */0,
                _0: ter1
...
function parse_statement(tokenList) {
  if (tokenList) {
    var remainingTokens = tokenList.tl;
    var token = tokenList.hd;
    if (Token.identificador(token) !== "ReturnKeyword") {
      return [
              {
                TAG: /* Err_state */2,
    ...
    var $$var = Token.identificador(token);
    ...
    if (remainingTokens$1) {
      ...
      if (Token.identificador(remainingTokens$1.hd) === "Semicolon") {
        return [
                {
                  TAG: /* Assign */0,
                  _0: $$var,
...
function parse_function(tokenList) {
  if (tokenList) {
    if (Token.identificador(tokenList.hd) !== "IntKeyword") {
      return {
              TAG: /* Err_fun */0,
              _0: "Error, falta int"
            };
    ...
    if (remainingTokens) {
      ...
      if (Token.identificador(token) !== "Id") {
        return {
                TAG: /* Err_fun */0,
      ...
      var idName = Token.extrac(token);
      if (remainingTokens$1) {
        if (Token.identificador(remainingTokens$1.hd) !== "OpenParen") {
          return {
                  TAG: /* Err_fun */0,
                  _0: "Error, falta ("
                };
        ...
        if (remainingTokens$2) {
          if (Token.identificador(remainingTokens$2.hd) !== "CloseParen") {
            return {
                    TAG: /* Err_fun */0,
                    _0: "Error, falta )"
                  };
          ...
          if (remainingTokens$3) {
            if (Token.identificador(remainingTokens$3.hd) !== "OpenBrace") {
              return {
                      TAG: /* Err_fun */0,
                      _0: "Error, falta {"
                    };
            ...
            if (Ast.identi_statement($$return) !== true) {
              return {
                      TAG: /* Err_fun */0,
                      _0: Ast.ext_state_err($$return)
                    };
            }
            if (remainingTokens$4) {
              if (Token.identificador(remainingTokens$4.hd) === "CloseBrace") {
                return {
                        TAG: /* Fun */1,
                        _0: idName,
                        _1: $$return
...
function parse_program(tokenList) {
  ...
  if (Ast.identi_fun_decl(func_decl) === true) {
    ...
    console.log(Ast.ext_fun_err(func_decl));
    return {
            TAG: /* Err_prog */1,
